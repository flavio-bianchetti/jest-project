...
Este repositório contém o projeto "_Jest_", requisito em atendimento ao módulo de Fundamentos - Testes automatizados com Jest, da Trybe. O projeto consiste em uma estrutura de pastas e arquivos que contém funções que deverão ser testadas.
